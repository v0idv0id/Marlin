...
#define STRING_CONFIG_H_AUTHOR "@jbrazio/@mjw" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 300, 1300 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER  0 //MJW   // Z offset: -below +above  [the nozzle]
